          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 商品类型管理 -> 商品类型列表</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">商品类型id</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><?php echo ($v["type_name"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19" align="center"><a href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>" style="color: rgb(59,99,99);">属性列表</a> | <img src="<?php echo U('AD_IMG_URL');?>/del.gif" width="10" height="10" />删除 | 查看 | <img src="<?php echo U('AD_IMG_URL');?>/edit.gif" width="10" height="10" /><a href="<?php echo U('upd',array('role_id'=>$v['role_id']));?>" style="color:rgb(59,99,117)">编辑</a></div></td>
