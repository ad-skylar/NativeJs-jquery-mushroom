...
<div  style="height:100%;">
	<ul id="navigation">
		<?php if(is_array($authinfoA)): foreach($authinfoA as $key=>$v): ?><li> <a class="head"><?php echo ($v["auth_name"]); ?></a>
	      <ul>
	      	<?php if(is_array($authinfoB)): foreach($authinfoB as $key=>$vv): if(($vv["auth_pid"]) == $v["auth_id"]): ?><li><a href="/admin/Home/<?php echo ($vv["auth_c"]); ?>/<?php echo ($vv["auth_a"]); ?>" target="rightFrame"><?php echo ($vv["auth_name"]); ?></a></li><?php endif; endforeach; endif; ?>
	      </ul>
