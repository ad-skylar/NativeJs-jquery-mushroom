        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              <a href="<?php echo U('tianjia');?>"><img src="<?php echo U('AD_IMG_URL');?>/add.gif" width="10" height="10" /> 添加</a>   &nbsp; 
              </span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="25%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">名称</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限pid</span></div></td>
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">控制器</span></div></td>
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作方法</span></div></td>
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><?php echo str_repeat('&nbsp;',$v['level']*2); echo ($v["auth_name"]); ?></div></td>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19" align="center"><a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>" style="color: rgb(59,99,99);">分配权限</a> | <img src="<?php echo U('AD_IMG_URL');?>/del.gif" width="10" height="10" />删除 | 查看 | <img src="<?php echo U('AD_IMG_URL');?>/edit.gif" width="10" height="10" /><a href="<?php echo U('upd',array('role_id'=>$v['role_id']));?>" style="color:rgb(59,99,117)">编辑</a></div></td>
